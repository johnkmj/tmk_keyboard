...
const uint8_t keymaps[][MATRIX_ROWS][MATRIX_COLS] PROGMEM = {
    ...
    KEYMAP(ESC, 1,   2,   3,   4,   5,   6,   7,   8,   9,   0,   MINS,EQL, BSLS,GRV,   \
           ...
           LSFT,Z,   X,   C,   V,   B,   N,   M,   COMM,DOT, SLSH,FN0,RGHT,    \
                LALT,LGUI,          SPC,                LGUI,LEFT),
     ...
     * |-----------------------------------------------------------|
     * |      |MUTE|VOLD|VOLU|MPLY|MNXT|  *|  /|Hom|PgU|Lef|Rig|Enter   |
     * |-----------------------------------------------------------|
     * |        |   |   |   |   |   |  +|  -|End|PgD|Dow|      |   |
     * `-----------------------------------------------------------'
     *       |   |     |                       |     |   |
    ...
    KEYMAP(PWR, F1,  F2,  F3,  F4,  F5,  F6,  F7,  F8,  F9,  F10, F11, F12,INS,TRNS,   \
           ...
           TRNS,MUTE,VOLD,VOLU,MPLY,MNXT,PAST,PSLS,TRNS,HOME,PGUP,UP,PENT,              \
